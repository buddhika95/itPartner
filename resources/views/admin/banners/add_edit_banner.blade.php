                    ...
                    <div class="form-group">
                        ...
                        <div>Recommended Image Size : Width:1170px, Height:480px</div>
                          @if(!empty($banner['image']))
                              <div> <img style="width:220px; margin-top:15px; margin-botoom:5px;" src="{{ asset('images/banner_images/'.$banner['image']) }}">
                                      &nbsp;
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="alt">Banner Alt text</label>
                        <input type="text" class="form-control" name="alt" id="alt"
                            placeholder="Enter Banner alt" @if(!empty($banner['alt']))
