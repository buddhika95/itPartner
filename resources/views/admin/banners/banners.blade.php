    ...
    <section class="content">
        <div class="row">
            ...
            <div class="card">
                ...
                <a href="{{url('admin/add-edit-banner')}}" style="max-width: 140px;float:right; display:inline-block" class="btn btn-block btn-success">Add Banners</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    @foreach ($banners as $banner)
                         ...
                         <tr>
                            ...
                            <td>
                                ...
                                <a title="Delete Product" href="javascript:void(0)" class="confirmDelete "  record="banner" recordid="{{ $banner['id']}}" <?php /*href="{{url('admin/delete-banner/'.$banner['id'])}}" */?> ><i style="color:red" class="fas fa-trash"></i></a>
                                &nbsp;&nbsp;
