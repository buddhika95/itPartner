    ...
    <section class="content">
        <div class="row">
            ...
            <div class="card">
                ...
                <a href="{{url('admin/add-edit-brand')}}" style="max-width: 140px;float:right; display:inline-block" class="btn btn-block btn-success">Add Brands</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    @foreach ($brands as $brand)
                         ...
                         <tr>
                            ...
                            <td>
                                ...
                                <a title="Delete Product" href="javascript:void(0)" class="confirmDelete "  record="brand" recordid="{{ $brand->id}}" <?php /*href="{{url('admin/delete-brand/'.$brand->id)}}" */?> ><i style="color:red" class="fas fa-trash"></i></a>
                                &nbsp;&nbsp;
